...
## GA4とSearch Consoleって何？

先に、今回導入した2つのツールが何をするものかを簡単に説明しておきます。

**GA4（Google Analytics 4）**
- サイトに来た人の**行動を記録する**ツール
- 何人が来たか、どのページを見たか、どこから来たか（検索/SNS/直接）がわかる
- ブログに1行のJSタグを埋め込むだけで動き出す
- 個人ブログなら完全無料

**Google Search Console**
- サイトが**Google検索にどう表示されているか**を教えてくれるツール
- どの検索キーワードで何回表示されたか、何回クリックされたか、何ページがインデックス登録されているかがわかる
- タグの埋め込みは不要（GA4が入っていれば連携認証できる）
- 完全無料

どちらもGoogleが提供する無料ツールで、セットで使うと「誰がどこから来て、検索ではどう見えているか」の全体像が把握できます。
